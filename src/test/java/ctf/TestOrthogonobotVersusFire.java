...
/**
 * Tests the {@link Orthogonobot} against the Fire sample robot.
 * 
 * @author Christopher Foo
 */
public class TestOrthogonobotVersusFire extends RobotTestBed {

  /**
   * Specifies that Fire and {@link Orthogonobot} are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Fire,ctf.Orthogonobot";
  }
  ...
  public void onBattleCompleted(BattleCompletedEvent event) {
    ...
    // Check to make sure Orthogonobot won a third of the rounds.
