...
/**
 * Tests the {@link Orthogonobot} against the SpinBot sample robot.
 * 
 * @author Christopher Foo
 */
public class TestOrthogonobotVersusSpinBot extends RobotTestBed {

  /**
   * Specifies that SpinBot and {@link Orthogonobot} are to be matched up in this test case.
   * 
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.SpinBot,ctf.Orthogonobot";
  }
